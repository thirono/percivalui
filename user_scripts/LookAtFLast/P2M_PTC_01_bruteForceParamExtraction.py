...
#
'''
##### BSI04, T-20, 3/7, biasBSI04_05, PGA6 ####
...
dflt_saveFlag='Y'; dflt_saveFlag='N';
dflt_outFolder= dflt_folder_data2process+'../PTCParam/'
dflt_outPrefix= '2020.05.14_BSI04_Tm20_dmuxSELHi_biasBSI04_05_3T_PGA666_(:,:)_xpix'
'''
#
#'''
##### BSI04, T-20, 7/7, biasBSI04_05, PGA6 ####
dflt_folder_data2process= '/gpfs/cfel/fsds/labs/percival/2020/calibration/20200505_000_BSI04_LatOvflw_PGA4or6BB/processed/PTC_BSI04_7of7ADC_biasBSI04_05_PGA6/avg_xGn/'
if dflt_folder_data2process[-1]!='/': dflt_folder_data2process+='/'
# tab-separated-text file, having 4 colums (file_light_avg, _light_std, _drk_avg, _drk_std)
dflt_metaFileName= '2020.06.10_BSI04_Tm20_7of7_biasBSI04.05_PTC.PGA6_meta.dat'
dflt_saveFlag='Y'; dflt_saveFlag='N';
dflt_outFolder= dflt_folder_data2process+'../PTCParam/'
dflt_outPrefix= '2020.06.10_BSI04_Tm20_7of7_biasBSI04.05_3T.PGA6_(:,:)_xpix'
#'''
...
#
    ...
    if (Cols2proc[-1]+1)%32 !=0:
        newColsROIendp1= Cols2proc[-1] -((Cols2proc[-1]+1)%32) +1
    ...
    #APy3_GENfuns.printcol('Pseudopads2proc array= {0}:{1}'.format(Pads2proc[0],Pads2proc[-1]), 'green')
...
#
    ...
    if (Cols2proc[-1]+1)%Xpix !=0:
        newColsROIendp1= Cols2proc[-1] -((Cols2proc[-1]+1)%Xpix) +1
