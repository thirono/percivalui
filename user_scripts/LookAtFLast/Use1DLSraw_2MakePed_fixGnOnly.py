# -*- coding: utf-8 -*-
"""
load descrambled save CDS avg (useful to make a pedestal)
...
or:
python3
exec(open("./UseFLastDLSraw_2MakePed.py").read())
"""
...
#
#'''
dflt_folder_data2process= '/gpfs/cfel/fsds/labs/percival/2019/calibration/20190826_000_temp_data/scratch/2019.12.11.14.14_drk_for_Pedestals/DLSraw/'
if dflt_folder_data2process[-1]!='/': dflt_folder_data2process+='/'
dflt_inputFilePrefix='2019.12.11.14.27.15_BSI04_7of7_3TPGA666_012ms_toCreatePedestal_1kdrk_'
...
GUIwin_arguments+= ['file name prefix'] 
GUIwin_arguments+= [dflt_inputFilePrefix] 
GUIwin_arguments+= ['file name suffix'] 
...
if folder_data2process[-1]!='/': folder_data2process+='/'
inputFilePrefix= dataFromUser[i_param]; i_param+=1
...
#
#%% what's up doc
APy3_GENfuns.printcol('will process data from {0}{1}'.format(folder_data2process,inputFile),'blue')
#
