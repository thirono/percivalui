...
percival-hl-configure-sensor-debug -i ./ELETTRA/W3C8/config/04_Sensor_Settings/SensorDebug_002_SET_CPNI.ini
# TOGGLE CPNI_EXT
...
percival-hl-configure-sensor-debug -i ./ELETTRA/W3C8/config/04_Sensor_Settings/SensorDebug_000_SAFE_START.ini
# ENTER ARMED STATUS
