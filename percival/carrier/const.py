...
SYSTEM_SETTINGS = UARTBlock(1, 8, 0x00C8)
SAFETY_SETTINGS = UARTBlock(2, 8, 0x00D0)
WRITE_BUFFER = UARTBlock(1, 32, 0x00D8)
COMMAND = UARTBlock(1, 3, 0x00F8)
READ_VALUES_PERIPHERY_LEFT = UARTBlock(1, 1, 0x00FB)
READ_VALUES_PERIPHERY_BOTTOM = UARTBlock(1, 1, 0x00FC)
READ_VALUES_CARRIER = UARTBlock(19, 1, 0x00FD)
READ_VALUES_PLUGIN = UARTBlock(1, 1, 0x0110)
READ_VALUES_STATUS = UARTBlock(1, 8, 0x0111)
READ_BUFFER = UARTBlock(1, 32, 0x0119)
READ_ECHO_WORD = UARTBlock(1, 1, 0x0139)
READBACK_HEADER_SETTINGS_LEFT = UARTBlock(1, 1, 0x013A)
READBACK_CONTROL_SETTINGS_LEFT = UARTBlock(1, 1, 0x013B)
READBACK_MONITORING_SETTINGS_LEFT = UARTBlock(1, 1, 0x013C)
READBACK_HEADER_SETTINGS_BOTTOM = UARTBlock(1, 1, 0x013D)
READBACK_CONTROL_SETTINGS_BOTTOM = UARTBlock(1, 1, 0x013E)
READBACK_MONITORING_SETTINGS_BOTTOM = UARTBlock(1, 1, 0x013F)
READBACK_HEADER_SETTINGS_CARRIER = UARTBlock(1, 1, 0x0140)
READBACK_CONTROL_SETTINGS_CARRIER = UARTBlock(1, 1, 0x0141)
READBACK_MONITORING_SETTINGS_CARRIER = UARTBlock(1, 1, 0x0142)
READBACK_HEADER_SETTINGS_PLUGIN = UARTBlock(1, 1, 0x0143)
READBACK_CONTROL_SETTINGS_PLUGIN = UARTBlock(1, 1, 0x0144)
READBACK_MONITORING_SETTINGS_PLUGIN = UARTBlock(1, 1, 0x0145)
READBACK_CHIP_READOUT_SETTINGS = UARTBlock(1, 1, 0x0146)
READBACK_CLOCK_SETTINGS = UARTBlock(1, 1, 0x0147)
READBACK_SYSTEM_SETTINGS = UARTBlock(1, 1, 0x0148)
READBACK_SAFETY_SETTINGS = UARTBlock(1, 1, 0x0149)
READBACK_WRITE_BUFFER = UARTBlock(1, 1, 0x014A)
READBACK_READ_VALUES_PERIPHERY_LEFT = UARTBlock(1, 1, 0x014B)
READBACK_READ_VALUES_PERIPHERY_BOTTOM = UARTBlock(1, 1, 0x014C)
READBACK_READ_VALUES_CARRIER = UARTBlock(1, 1, 0x014D)
READBACK_READ_VALUES_PLUGIN = UARTBlock(1, 1, 0x014E)
READBACK_READ_VALUES_STATUS = UARTBlock(1, 1, 0x014F)
READBACK_READ_BUFFER = UARTBlock(1, 1, 0x0150)
READBACK_READ_ECHO_WORD = UARTBlock(1, 1, 0x0151)
