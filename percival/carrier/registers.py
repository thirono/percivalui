...
class MonitoringChannelMap(RegisterMap):
    ...
    def __init__(self):
        ...
        self._mem_map = {"channel_id":                   MapField("channel_id",                  0,  5, 27),
                         ...
                         "safety_action_0_select":       MapField("safety_action_0_select",      3,  1, 23),
                         "safety_action_1_select":       MapField("safety_action_1_select",      3,  1, 22),
                         "safety_action_2_select":       MapField("safety_action_2_select",      3,  1, 21),
                         "safety_action_3_select":       MapField("safety_action_3_select",      3,  1, 20),
                         "safety_action_4_select":       MapField("safety_action_4_select",      3,  1, 19),
                         "safety_action_5_select":       MapField("safety_action_5_select",      3,  1, 18),
                         "safety_action_6_select":       MapField("safety_action_6_select",      3,  1, 17),
