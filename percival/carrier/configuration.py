...
class MonitoringChannelIniParameters(IniSectionParameters):
    ...
    def __init__(self, channel_number):
        ...
        self._parameters = {"UART_address": (0, int),
                            ...
                            "Safety_action_0_select": (0, int),
                            "Safety_action_1_select": (0, int),
                            "Safety_action_2_select": (0, int),
                            "Safety_action_3_select": (0, int),
                            "Safety_action_4_select": (0, int),
                            "Safety_action_5_select": (0, int),
                            "Safety_action_6_select": (0, int),
                            "Safety_action_7_select": (0, int),
