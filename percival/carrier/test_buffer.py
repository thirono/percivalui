...
class TestBuffer(unittest.TestCase):
    ...
    def TestSensorBufferCommand(self):
        ...
        self.assertEqual(calls[8], call(bytes("\x03\x02\x00\x00\x00\x08", encoding="latin-1"), None))
        self.assertEqual(calls[9], call(bytes("\x03\x03\x00\x00\x00\x09", encoding="latin-1"), None))
        self.assertEqual(calls[70], call(bytes("\x03\x1C\x00\x00\x00\x46", encoding="latin-1"), None))
        self.assertEqual(calls[71], call(bytes("\x03\x1D\x00\x00\x00\x47", encoding="latin-1"), None))
        self.assertEqual(calls[72], call(bytes("\x02\xFA\x00\x00\x00\x48", encoding="latin-1"), None))
        self.assertEqual(calls[73], call(bytes("\x02\xFB\x00\x00\x00\x49", encoding="latin-1"), None))
        self.assertEqual(calls[74], call(bytes("\x02\xFC\x00\x00\x00\x4A", encoding="latin-1"), None))
        self.assertEqual(calls[75], call(bytes("\x02\xFD\x00\x00\x00\x4B", encoding="latin-1"), None))
        self.assertEqual(calls[76], call(bytes("\x02\xFE\x00\x00\x00\x4C", encoding="latin-1"), None))
        self.assertEqual(calls[77], call(bytes("\x02\xFF\x00\x00\x00\x4D", encoding="latin-1"), None))
        self.assertEqual(calls[78], call(bytes("\x03\x00\x00\x00\x00\x4E", encoding="latin-1"), None))
        self.assertEqual(calls[79], call(bytes("\x03\x01\x00\x00\x00\x4F", encoding="latin-1"), None))
        self.assertEqual(calls[3000], call(bytes("\x03\x06\x00\x00\x0B\xB8", encoding="latin-1"), None))
        self.assertEqual(calls[3001], call(bytes("\x03\x07\x00\x00\x0B\xB9", encoding="latin-1"), None))
        self.assertEqual(calls[3002], call(bytes("\x03\x08\x00\x00\x0B\xBA", encoding="latin-1"), None))
        self.assertEqual(calls[3003], call(bytes("\x03\x09\x00\x00\x0B\xBB", encoding="latin-1"), None))
        self.assertEqual(calls[3004], call(bytes("\x03\x0A\x00\x00\x0B\xBC", encoding="latin-1"), None))
        self.assertEqual(calls[3005], call(bytes("\x03\x0B\x00\x00\x0B\xBD", encoding="latin-1"), None))
        self.assertEqual(calls[3006], call(bytes("\x03\x0C\x00\x00\x0B\xBE", encoding="latin-1"), None))
        self.assertEqual(calls[3007], call(bytes("\x03\x0D\x00\x00\x0B\xBF", encoding="latin-1"), None))
        self.assertEqual(calls[3008], call(bytes("\x03\x0E\x00\x00\x0B\xC0", encoding="latin-1"), None))
        self.assertEqual(calls[3009], call(bytes("\x03\x0F\x00\x00\x0B\xC1", encoding="latin-1"), None))
        # Verify that the correct calls were made to the txrx object for sending the buffer commands
        calls = self.txrx.send_recv_message.mock_calls
        # Assert that the commands were sent in the correct order
        self.assertEqual(calls[0], call(TxMessage(bytes("\x03\x3B\x50\x00\x00\x00", encoding="latin-1"),
                                                  num_response_msg=1,
                                                  expect_eom=False)))
        self.assertEqual(calls[1], call(TxMessage(bytes("\x03\x3B\x52\x00\x00\x01", encoding="latin-1"),
                                                  num_response_msg=2,
                                                  expect_eom=False)))
        self.assertEqual(calls[2], call(TxMessage(bytes("\x03\x3B\x50\x00\x00\x00", encoding="latin-1"),
                                                  num_response_msg=1,
                                                  expect_eom=False)))
        self.assertEqual(calls[3], call(TxMessage(bytes("\x03\x3B\x52\x00\x00\x02", encoding="latin-1"),
                                                  num_response_msg=2,
                                                  expect_eom=False)))
        self.assertEqual(calls[4], call(TxMessage(bytes("\x03\x3B\x50\x00\x00\x00", encoding="latin-1"),
                                                  num_response_msg=1,
                                                  expect_eom=False)))
        self.assertEqual(calls[5], call(TxMessage(bytes("\x03\x3B\x52\x00\x00\x03", encoding="latin-1"),
                                                  num_response_msg=2,
                                                  expect_eom=False)))
        self.assertEqual(calls[80], call(TxMessage(bytes("\x03\x3B\x50\x00\x00\x00", encoding="latin-1"),
                                                  num_response_msg=1,
                                                  expect_eom=False)))
        self.assertEqual(calls[81], call(TxMessage(bytes("\x03\x3B\x52\x00\x00\x29", encoding="latin-1"),
                                                  num_response_msg=2,
                                                  expect_eom=False)))
        self.assertEqual(calls[82], call(TxMessage(bytes("\x03\x3B\x50\x00\x00\x00", encoding="latin-1"),
                                                  num_response_msg=1,
                                                  expect_eom=False)))
        self.assertEqual(calls[83], call(TxMessage(bytes("\x03\x3B\x52\x00\x00\x2A", encoding="latin-1"),
                                                  num_response_msg=2,
                                                  expect_eom=False)))
        self.assertEqual(calls[84], call(TxMessage(bytes("\x03\x3B\x50\x00\x00\x00", encoding="latin-1"),
                                                  num_response_msg=1,
                                                  expect_eom=False)))
        self.assertEqual(calls[85], call(TxMessage(bytes("\x03\x3B\x52\x00\x00\x2B", encoding="latin-1"),
                                                  num_response_msg=2,
                                                  expect_eom=False)))
        ...
        self.assertEqual(calls[2], call(bytes("\x02\xFC\x00\x00\x00\x03", encoding="latin-1"), None))
        self.assertEqual(calls[3], call(bytes("\x02\xFD\x00\x00\x00\x04", encoding="latin-1"), None))
        self.assertEqual(calls[4], call(bytes("\x02\xFE\x00\x00\x00\x05", encoding="latin-1"), None))
        self.assertEqual(calls[5], call(bytes("\x02\xFF\x00\x00\x00\x06", encoding="latin-1"), None))
        self.assertEqual(calls[6], call(bytes("\x03\x00\x00\x00\x00\x07", encoding="latin-1"), None))
        self.assertEqual(calls[7], call(bytes("\x03\x01\x00\x00\x00\x08", encoding="latin-1"), None))
        self.assertEqual(calls[8], call(bytes("\x03\x02\x00\x00\x00\x09", encoding="latin-1"), None))
        ...
        self.assertEqual(calls[0], call(TxMessage(bytes("\x03\x3B\x50\x00\x00\x00", encoding="latin-1"),
                                                  num_response_msg=1,
                                                  expect_eom=False)))
        self.assertEqual(calls[1], call(TxMessage(bytes("\x03\x3B\x54\x00\x00\x01", encoding="latin-1"),
                                                  num_response_msg=2,
                                                  expect_eom=False)))
