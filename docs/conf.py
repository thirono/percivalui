# -*- coding: utf-8 -*-
#
# PercivalUI documentation build configuration file, created by
...
copyright = u'2014, Ulrik Kofoed Pedersen, Diamond Light Source Ltd.'
...
htmlhelp_basename = 'PercivalUIdoc'
