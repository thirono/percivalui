...
# this file: descramble, ADUcorr, CDS/CMA Gn0 if needed, LatOvflw to electron, save to 4 files
# use:
# ./<thisfile>.sh
...
#using /asap3 files
inFolder="/asap3/fs-ds-percival/gpfs/percival.sys.1/2020/data/11010234/processed/example2_of_data_processing/input_scrmbld/"
prefix_fl="2019.12.11.23.37.16_BSI04_7of7_3TPGA666_012ms_0250eV_5um_1kpin_"
...
#
#using /asap3 files
MultiGnCal="/asap3/fs-ds-percival/gpfs/percival.sys.1/2020/data/11010234/shared/CalibParamToUse/BSI04/BSI04_Tm20/BSI04_Tm20_dmuxSELHi_biasBSI04_05_PGA6BB_Gn012_2020.05.14b_MultiGnCal_gapsAvg.h5"
#
#using /asap3 files
altPed="/asap3/fs-ds-percival/gpfs/percival.sys.1/2020/data/11010234/shared/Pedestals/2019.12.11.14.27.15_BSI04_7of7_3TPGA666_012ms_toCreatePedestal_1kdrk_Gn0_CDS_ADU_drkavg.h5"
#
CMAcols="NONE"
CDSFlag="Y"
#
#using /asap3 folder
outFolder="/asap3/fs-ds-percival/gpfs/percival.sys.1/2020/data/11010234/processed/example2_of_data_processing/output_electrons/"
#
#echo $inFolder  
#
