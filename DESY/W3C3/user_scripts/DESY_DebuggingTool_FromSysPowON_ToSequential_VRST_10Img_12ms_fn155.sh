...
echo "Load ADC25MHz, PLL120MHz, VRST (fn counts up to 155),PGAB SequentialMode, 10 Images, 12ms integration"
percival-hl-configure-clock-settings -i ./DESY/W3C3/config/01_Clock_Settings/ClockSettings_N06_120MHz_ACD25MHz.ini
percival-hl-configure-chip-readout-settings -i ./DESY/W3C3/config/02_Chip_Readout_Settings/ChipReadoutSettings_Debug15_fn155_VRST_ADC25MHz_PLL120MHz_SEQUENTIAL.ini
