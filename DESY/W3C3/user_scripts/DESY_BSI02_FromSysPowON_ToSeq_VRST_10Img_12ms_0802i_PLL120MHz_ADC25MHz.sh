...
echo change biases from standard-after-PowON-status to 08_2i-status , BSI02 VRST-the-same-bias-as-3T  
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_2i_BSI02_3T -n 2 -d 500

echo Load ADC25MHz, PLL120MHz, VRST, SequentialMode, 10 Images, 12ms integration
...
echo  VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST
