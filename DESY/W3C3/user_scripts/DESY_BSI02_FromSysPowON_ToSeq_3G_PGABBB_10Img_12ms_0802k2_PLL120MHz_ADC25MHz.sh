...
echo "change biases from standard-after-PowON-status to 08_2k2-status , BSI02 3G (VrefDB=2V)"
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_2k2_BSI02_3G -n 4 -d 2000
...
echo  "3G,PGABBB,080k2(BSI02) 3G,PGABBB,080k2(BSI02) 3G,PGABBB,080k2(BSI02)"
