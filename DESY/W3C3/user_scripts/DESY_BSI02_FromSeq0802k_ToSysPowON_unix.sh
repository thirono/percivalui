...
echo "change biases from BSI2-SeqMod(0802k)-status to standard-after-PowON-status"
percival-hl-scan-setpoints -i 08_2k_BSI02_3G -f 08_1_CurrentBiases_ON_ready3T -n 4 -d 2000
