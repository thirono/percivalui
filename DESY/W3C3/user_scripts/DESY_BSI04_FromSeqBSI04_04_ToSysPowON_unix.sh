...
echo "change biases from BSI04_04_3GPGABBB-SeqMod-status to standard-after-PowON-status" 
percival-hl-scan-setpoints -i BSI04_04_3GPGABBB -f 08_1_CurrentBiases_ON_ready3T -n 4 -d 2000
