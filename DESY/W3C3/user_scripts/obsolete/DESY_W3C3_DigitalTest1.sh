...
percival-hl-set-system-setting -s ADVANCED_CPNI_EXT_options -v 0
percival-hl-set-system-setting -s ADVANCED_sr7SC_EXT_options -v 0
...
percival-hl-set-system-setting -s ACQUISITION_Continuous_acquisition -v 1
