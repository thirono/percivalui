...
echo change biases from standard-after-PowON-status to sandbox-status 
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_3_sandbox -n 4 -d 2000
