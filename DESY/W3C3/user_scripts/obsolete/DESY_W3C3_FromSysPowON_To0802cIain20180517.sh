...
echo change biases from standard-after-PowON-status to 08_02c status 
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_2c_Test -n 4 -d 2000

echo Load 25MHz, VRSTscan operating status
percival-hl-configure-clock-settings -i ./DESY/W3C3/config/01_Clock_Settings/ClockSettings_N06_120MHz_ACD25MHz.ini
percival-hl-configure-chip-readout-settings -i ./DESY/W3C3/config/02_Chip_Readout_Settings/ChipReadoutSettings_N06_VRST_120MHz_ADC25MHz.ini
...
# DEASSERT ALL FLAGS IN DEBUG REGISTERS - this means do not use any of the cpniEXT, pllEXT etc inputs. "regular operation"
