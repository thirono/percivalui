...
echo change biases from standard-after-PowON-status to 08_2f_Test-status 
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_2f_Test -n 4 -d 2000

echo Load ADC25MHz, PLL120MHz, RST always active, SequentialMode, 10 Images, 12ms integration
