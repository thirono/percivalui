...
echo change biases from PGA-status to PGABypass-status 
percival-hl-scan-setpoints -i 08_2j_BSI02_PGA -f 08_2i_BSI02_3T -n 4 -d 2000

echo - setting PGA Bypass
percival-hl-configure-chip-readout-settings -i ./DESY/W3C3/config/02_Chip_Readout_Settings/ChipReadoutSettings_N16_3T_PGAB_ADC25MHz_PLL120MHz_Seq.ini
...
echo  DONE PGABypass PGABypass PGABypass PGABypass PGABypass
