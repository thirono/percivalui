...
echo change biases from standard-after-PowON-status to 08_2d_Test-status 
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_2e_Test -n 4 -d 2000

echo Load 25MHz, PLL 133 MHz, VRSTscan operating status
percival-hl-configure-clock-settings -i ./DESY/W3C3/config/01_Clock_Settings/ClockSettings_N08c_PLL133MHz_ADC25MHz.ini
percival-hl-configure-chip-readout-settings -i ./DESY/W3C3/config/02_Chip_Readout_Settings/ChipReadoutSettings_N08c_VRST_PLL133MHz_ADC25MHz.ini
percival-hl-configure-system-settings -i ./DESY/W3C3/config/03_System_Settings/SystemSettings_N06_VRST_Test.ini
