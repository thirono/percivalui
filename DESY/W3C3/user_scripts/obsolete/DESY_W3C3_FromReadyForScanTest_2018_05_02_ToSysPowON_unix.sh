...
echo change biases from status-to-make-test-with to standard-after-PowON 
percival-hl-scan-setpoints -i 08_2_Test -f 08_1_CurrentBiases_ON_ready3T -n 4 -d 2000
