...
echo change biases from standard-after-PowON to status-to-make-test-with 
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_2_Test -n 4 -d 2000
