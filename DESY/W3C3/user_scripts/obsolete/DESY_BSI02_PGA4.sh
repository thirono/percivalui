...
echo - setting PGA 4
percival-hl-configure-chip-readout-settings -i ./DESY/W3C3/config/02_Chip_Readout_Settings/ChipReadoutSettings_N16_3T_PGA4_ADC25MHz_PLL120MHz_Seq.ini
...
echo  DONE PGA4 PGA4 PGA4 PGA4 PGA4 PGA4 PGA4 PGA4 PGA4 PGA4 
