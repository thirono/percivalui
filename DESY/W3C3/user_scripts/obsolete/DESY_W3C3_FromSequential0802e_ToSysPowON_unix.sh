...
echo change biases from 08_2e_Test-status to standard-after-PowON-status 
percival-hl-scan-setpoints -i 08_2e_Test -f 08_1_CurrentBiases_ON_ready3T -n 4 -d 2000
