...
echo change biases from standard-after-PowON-status to 08_02b status 
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_2b_Test -n 4 -d 2000
