...
echo change biases from standard-after-PowON-status to 10DebugMode-status, clkADC 25MHz 
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 10_Debug -n 4 -d 2000

echo Load 25MHz, debug VRSTscan operating status, No S0,S1, 10 Images per Acquisition
percival-hl-configure-clock-settings -i ./DESY/W3C3/config/01_Clock_Settings/ClockSettings_N06_120MHz_ACD25MHz.ini
percival-hl-configure-system-settings -i ./DESY/W3C3/config/03_System_Settings/SystemSettings_N10_Debug.ini
percival-hl-configure-chip-readout-settings -i ./DESY/W3C3/config/02_Chip_Readout_Settings/ChipReadoutSettings_N10b2_debug_VRST_PLL120MHz,ADC40MHz_noS0,S1.ini
