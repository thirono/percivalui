...
echo change biases from standard-after-PowON-status to 08_2e_Test-status 
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_2e_Test -n 4 -d 2000

echo Load 25MHz, VRSTscan operating status, No S0 and S1, 10 Images per Acquisition
percival-hl-configure-clock-settings -i ./DESY/W3C3/config/01_Clock_Settings/ClockSettings_N06_120MHz_ACD25MHz.ini
percival-hl-configure-chip-readout-settings -i ./DESY/W3C3/config/02_Chip_Readout_Settings/ChipReadoutSettings_N06c_VRST_120MHz_ADC25MHz_S0,S1_0.ini
percival-hl-configure-system-settings -i ./DESY/W3C3/config/03_System_Settings/SystemSettings_N08_VRST_Test.ini
...
echo  DONE
echo VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST VRST
