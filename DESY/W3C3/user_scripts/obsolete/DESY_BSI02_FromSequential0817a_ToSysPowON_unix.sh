...
echo "change biases from 08_17a-status to standard-after-PowON-status" 
percival-hl-scan-setpoints -i 08_17a_BSI02_3T_FSkip -f 08_1_CurrentBiases_ON_ready3T -n 4 -d 2000
