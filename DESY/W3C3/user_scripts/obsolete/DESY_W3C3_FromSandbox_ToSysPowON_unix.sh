...
echo change biases from sandbox-status to standard-after-PowON-status 
percival-hl-scan-setpoints -i 08_3_sandbox -f 08_1_CurrentBiases_ON_ready3T -n 4 -d 2000
