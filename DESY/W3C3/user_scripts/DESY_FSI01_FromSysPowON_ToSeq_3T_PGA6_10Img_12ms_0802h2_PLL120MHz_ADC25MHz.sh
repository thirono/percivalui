...
echo "change biases from standard-after-PowON-status to 08_2h2-status , FSI01 3T"
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_2h2_PGA -n 4 -d 2000
...
echo  "3T,PGA6,0802h2 3T,PGA6,0802h2 3T,PGA6,0802h2 3T,PGA6,0802h2"
