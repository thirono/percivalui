...
echo change "biases from standard-after-PowON-status to BSI04_03_PGA6 , BSI04 3T(PGA666)"  
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f BSI04_03_PGA6 -n 4 -d 2000

echo Load ADC25MHz, PLL120MHz, 3T,PGA666 SequentialMode, 10 Images, 12ms integration
...
echo  "3T,PGA666,BSI04_03, 3T,PGA666 BSI04_03, 3T,PGA666,BSI04_03"
