...
echo "change biases from BSI2-SeqMod(0802j)-status to standard-after-PowON-status"
percival-hl-scan-setpoints -i 08_2j_BSI02_PGA -f 08_1_CurrentBiases_ON_ready3T -n 4 -d 2000
...
echo  "DONE"
echo  "FullSpeedMode FullSpeedMode FullSpeedMode FullSpeedMode"
