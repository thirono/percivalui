echo -n "load readout.ini for adc PSVolt"
percival-hl-configure-chip-readout-settings -i ./DESY/W3C3/config/02_Chip_Readout_Settings/ChipReadoutSettings_N15c_PSVolt.ini
...
echo  "should be ready for adc PSVolt"
