...
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_2g_Test -n 4 -d 2000

echo "Load ADC25MHz, PLL120MHz, VRST (crs counts up to 12),PGAB SequentialMode, 10 Images, 12ms integration"
percival-hl-configure-clock-settings -i ./DESY/W3C3/config/01_Clock_Settings/ClockSettings_N06_120MHz_ACD25MHz.ini
percival-hl-configure-chip-readout-settings -i ./DESY/W3C3/config/02_Chip_Readout_Settings/ChipReadoutSettings_Debug15_crs12_VRST_ADC25MHz_PLL120MHz_SEQUENTIAL.ini
