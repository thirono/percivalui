...
echo "change biases from FSI2-SeqMod(0802h3)-status to standard-after-PowON-status" 
percival-hl-scan-setpoints -i 08_2h3_3G -f 08_1_CurrentBiases_ON_ready3T -n 4 -d 2000
