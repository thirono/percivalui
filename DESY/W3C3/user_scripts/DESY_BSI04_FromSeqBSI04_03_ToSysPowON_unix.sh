...
echo "change biases from BSI04_03_PGA6-SeqMod-status to standard-after-PowON-status" 
percival-hl-scan-setpoints -i BSI04_03_PGA6 -f 08_1_CurrentBiases_ON_ready3T -n 4 -d 2000
