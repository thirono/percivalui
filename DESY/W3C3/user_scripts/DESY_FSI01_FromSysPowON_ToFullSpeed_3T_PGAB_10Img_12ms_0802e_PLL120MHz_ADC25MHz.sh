...
echo "change biases from standard-after-PowON-status to 08_2e-status , FSI01 3T"
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f 08_2e_Test -n 4 -d 2000

echo "Load ADC25MHz, PLL120MHz, 3T,PGAB FullSpeedMode, 10 Images, 12ms integration"
percival-hl-configure-clock-settings -i ./DESY/W3C3/config/01_Clock_Settings/ClockSettings_N06_120MHz_ACD25MHz.ini
percival-hl-configure-chip-readout-settings -i ./DESY/W3C3/config/02_Chip_Readout_Settings/ChipReadoutSettings_N06a_3T_120MHz_ADC25MHz.ini
percival-hl-configure-system-settings -i ./DESY/W3C3/config/03_System_Settings/SystemSettings_N08a_10Img_12ms_FullSpeed.ini
...
echo  "FullSpeedMod,FullSpeedMod,FullSpeedMod,FullSpeedMod"
echo  "10img,12ms 10img,12ms 10img,12ms 10img,12ms 10img,12ms 10img,12ms"
echo  "3T,PGAB,0802e(FSI01) 3T,PGAB,0802e(FSI01) 3T,PGAB,0802e(FSI01)"
