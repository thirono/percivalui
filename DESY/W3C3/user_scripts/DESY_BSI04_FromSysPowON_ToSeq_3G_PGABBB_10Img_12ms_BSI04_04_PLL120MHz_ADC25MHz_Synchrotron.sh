...
echo "change biases from standard-after-PowON-status to BSI04_04_3GPGABBB-status, BSI04 3G PGABBB (VrefDB=2V)"
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f BSI04_04_3GPGABBB -n 4 -d 2000

echo "Load ADC25MHz, PLL120MHz, 3G,PGABBB SequentialMode, 10 Images, 12ms integration, Synchrotron(continuous integration)"
...
echo  "10img,12ms 10img,12ms 10img,12ms 10img,12ms 10img,12ms"
echo  "3G,PGABBB,BSI04_04 3G,PGABBB,BSI04_04 3G,PGABBB,BSI04_04"
