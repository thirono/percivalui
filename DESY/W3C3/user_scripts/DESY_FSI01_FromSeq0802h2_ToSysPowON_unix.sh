...
echo "change biases from FSI2-SeqMod(0802h2)-status to standard-after-PowON-status" 
percival-hl-scan-setpoints -i 08_2h2_PGA -f 08_1_CurrentBiases_ON_ready3T -n 4 -d 2000
