...
echo "change biases from BSI04_02_3T-SeqMod-status to standard-after-PowON-status" 
percival-hl-scan-setpoints -i BSI04_02_3T -f 08_1_CurrentBiases_ON_ready3T -n 4 -d 2000
