...
python tool_ADC_acquisitions.py -w 7 --nimages=10
loop on many bias values: set filename, set new bias, wait 7sec, acquire 10 img, wait 7sec
'''
...
out_prefix= '2019.11.15_BSI04_Tm20_dmuxSELsw_BSI04_00_VRST_PGABBB_VRSTfromVin'
