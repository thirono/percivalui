...
example
python tool_acquire_whidra.py -w 0.1 -p test -n 10 -t 1200000
...
def main():
    ...
    # set output folder
    #out_folder= '/home/prcvlusr/PercAuxiliaryTools/temp_data/' # local storage on cfeld-perc02
    # note that cfeld-perc01 MUST have the same folder

    #
    out_folder= '/ramdisk/cfel/fsds/labs/percival/2019/calibration/20190826_000_temp_data/scratch/'  # ramdisk on cfeld-perc02
    # note that cfeld-perc01 MUST have the same folder
    # note that gpfs MUST have the same folder, only starting as /gpfs/cfel/fsds/... intead of /ramdisk/cfel/fsds/...
